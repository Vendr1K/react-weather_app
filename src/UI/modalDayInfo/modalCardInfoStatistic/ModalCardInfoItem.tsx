...
export function ModalCardInfoItem({temp, pressure, precipitation, wind}: Props) {
  ...
  return (
    <ul className={styles.modal_list}>
      ...
      <li className={styles.modal_list__item}>
        <div className={styles.modal_list__item__icon}>
          <IndicatorSvgSelector id='temp' />
        </div>
        <div className={styles.modal_list__item__descr}>
          <span className={styles.modal_list__item__descr__name}>{temp.name}: </span>
          <span className={styles.modal_list__item__descr__value}>{`${tempNow}° - ощущается как ${tempFeels}°` }</span>
        </div>
      </li>
      <li className={styles.modal_list__item}>
        <div className={styles.modal_list__item__icon}>
        ...
        <div className={styles.modal_list__item__descr}>
          <span className={styles.modal_list__item__descr__name}>{pressure.name}:</span>
          <span className={styles.modal_list__item__descr__value}>
      ...
      <li className={styles.modal_list__item}>
        ...
        <div className={styles.modal_list__item__descr}>
          <span className={styles.modal_list__item__descr__name}>{precipitation.name}: </span>
          <span className={styles.modal_list__item__descr__value}>{precipitation.precipitation ? `${precipitation.precipitation} мм/ч` : 'без осадков'}</span>
        </div>
      </li>
      ...
      <li className={styles.modal_list__item}>
        ...
        <div className={styles.modal_list__item__descr}>
          <span className={styles.modal_list__item__descr__name}>{wind.name}: </span>
          <span className={styles.modal_list__item__descr__value}>{` ${windDer}, ${wind.windSpeed} м/с, порывы ${wind.windGust} м/с ` }</span>
        </div>
      </li>
  </ul>
  );
